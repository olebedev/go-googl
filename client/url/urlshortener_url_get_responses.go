...
func (o *UrlshortenerURLGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUrlshortenerURLGetOK()
...
func (o *UrlshortenerURLGetOK) Error() string {
	return fmt.Sprintf("[GET /url][%d] urlshortenerUrlGetOK  %+v", 200, o.Payload)
}

func (o *UrlshortenerURLGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
